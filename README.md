...
- **Auto mode 分类器适配（实验性）** - 在 Key 的模型映射中启用，可跟随当前 Claude 会话或指定分类器模型，支持低思考与关闭思考；默认关闭。详见 [v3.9.0 使用说明](https://github.com/mipawn/cc-use-docs/blob/main/v3.9.0/README.md)。
